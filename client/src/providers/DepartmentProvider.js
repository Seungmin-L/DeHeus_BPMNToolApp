...
import parametersProps from './props/Department/ParametersProp';
 ...
 */
export default function DepartmentPropertiesProvider(propertiesPanel, injector, translate) {
...
DepartmentPropertiesProvider.$inject = [ 'propertiesPanel', 'injector', 'translate' ];
